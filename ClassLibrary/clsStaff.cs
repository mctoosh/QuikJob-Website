...
namespace ClassLibrary
{
    public class clsStaff
    {
        ...
        public bool Valid(string First_Name, string Last_Name, string Email, string Address, string Postcode, string Password, string Age, string Phone_Number, string Staff_CV)
        {
        ...
        public bool Find(int StaffId)
        {
            ...
            DB.Execute("sproc_Staff_Registration_FilterByStaffId");
            ...
            if (DB.Count == 1)
            {
                ...
                mStaff_CV = Convert.ToString(DB.DataTable.Rows[0]["Staff_CV"]);
