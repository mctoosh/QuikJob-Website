...
public partial class user_Display_Jobs_Applied : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select * from User_Display where User_Email='" +Session["user"].ToString()+"'  order by id desc";
